...
import ru.datamart.kafka.postgres.writer.configuration.AppConfiguration;
import ru.datamart.kafka.postgres.writer.configuration.properties.VerticleProperties;
import ru.datamart.kafka.postgres.writer.controller.InsertDataController;
import ru.datamart.kafka.postgres.writer.controller.VersionController;
import ru.datamart.kafka.postgres.writer.verticle.handler.SendResponseHandler;
