 ...
 */
package ru.datamart.kafka.postgres.reader.factory;

import ru.datamart.kafka.postgres.avro.codec.AvroQueryResultEncoder;
import ru.datamart.kafka.postgres.reader.model.KafkaBrokerInfo;
import ru.datamart.kafka.postgres.reader.model.QueryResultItem;
import ru.datamart.kafka.postgres.reader.service.KafkaProducerProvider;
import ru.datamart.kafka.postgres.reader.service.PublishService;
import ru.datamart.kafka.postgres.reader.upstream.QueryResultUpstream;
